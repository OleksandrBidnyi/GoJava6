...
public class GoogleAPI implements API {
    ...
    public GoogleAPI() {
        rooms[0] = new Room(2111, 100, 1, new Date(2016, 12, 22), "National", "Kyiv");
        rooms[1] = new Room(2112, 200, 2, new Date(2016, 11, 22), "Goloseevo", "Lviv");
        rooms[2] = new Room(2113, 100, 1, new Date(2016, 10, 23), "Olympic", "Kyiv");

...
public class TripAdvisorAPI implements API {
    ...
    public TripAdvisorAPI() {
        rooms[0] = new Room(3111, 100, 1, new Date(2016, 12, 22), "Holiday", "Kyiv");
        rooms[1] = new Room(3112, 200, 2, new Date(2016, 11, 22), "Season", "Chernigiv");
        rooms[2] = new Room(3113, 100, 1, new Date(2016, 10, 23), "Apart", "Kyiv");
